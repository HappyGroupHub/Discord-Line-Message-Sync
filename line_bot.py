...
def handle_message(event):
    ...
    if event.source.type == 'group':
        ...
        if group_id in config['subscribed_line_channels']:
            sub_num = config['subscribed_line_channels'].index(group_id) + 1
            ...
            discord_webhook = SyncWebhook.from_url(config[f'discord_channel_webhook_{sub_num}'])
